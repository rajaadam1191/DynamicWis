<%@ Page Language="C#" MasterPageFile="~/MasterPage1.master" AutoEventWireup="true"
    CodeFile="SpeedLossTemplate.aspx.cs" Inherits="SpeedLossTemplate" Title="PH :: SpeedLoss BarcodeTemplate" %>
                    ...
                    <div style="margin-top: 5px;">
                        <table>
                         ...
                         &nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <td>
                                    <asp:Label ID="Label3" runat="server" Text="SPEEDLOSS TEMPLATE" valign="left" Font-Bold="true"
