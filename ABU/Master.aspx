<%@ Page Language="C#" MasterPageFile="~/AbuMaster.master" AutoEventWireup="true"
    CodeFile="Master.aspx.cs" Inherits="ABU_Master" Title="Untitled Page" %>
    ...
    <div>
        ...
        <div>
            <table align="center">
                <tr>
                    <td align="left">
                        <span class="lablestyle" style="color:#fff;">Unit Name</span>
                    </td>
                    <td>
                        :
                    </td>
                        ...
                        <asp:GridView ID="grid_abumaster" runat="server" BorderColor="AliceBlue" 
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Edit" ControlStyle-Width="50pt">
                                    <ItemTemplate>
                                        <a id="<%# Eval("MID") %>" onclick="javascript:edit_master(this.id);">
                                ...
                                <asp:TemplateField HeaderText="Delete" ControlStyle-Width="50pt">
                                    <ItemTemplate>
                                        <a id="<%# Eval("MID") %>" onclick="javascript:delete_master(this.id);">
