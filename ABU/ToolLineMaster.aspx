<%@ Page Language="C#" MasterPageFile="~/AbuMaster.master" AutoEventWireup="true"
    CodeFile="ToolLineMaster.aspx.cs" Inherits="ABU_Master" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
       ...
       <div style="margin-top: 50px; margin-left:600px;"  align="center" >
        ...
        <div>
            <table align="center">
                <tr>
                    <td align="left">
                        <span class="lablestyle" style="color:#fff;">Tool Line Value</span>
                    </td>
                    <td>
                        :
                    </td>
                    <td colspan="2">
                        <input type="text" id="txt_lvalue" class="textboxstyle" runat="server" />
                    </td>
                </tr>
                <tr style="height: 5px;">
                    <td colspan="4">
                ...
                <tr>
                    <td align="left">
                        <span class="lablestyle" style="color:#fff;">Tool Line Name</span>
                    </td>
                    <td>
                        :
                    </td>
                    <td colspan="2">
                        <input type="text" id="txt_lname" class="textboxstyle" runat="server" />
                    </td>
                </tr>
                <tr style="height: 5px;">
                    <td colspan="4">
                        ...
                        <div align="center">
                            <div align="center" style="padding-left: 30px;" id="div_toolsave" runat="server">
                                <asp:ImageButton ID="btn_submit" runat="server" Text="Save" color="black" ImageUrl="~/Menu_image/Save.jpg"
                                    OnClick="btn_submit_Click" OnClientClick="return valtooline();"/>
                            </div>
                            <div align="center" style="padding-left: 30px; display: none;" id="div_toolupdate"
                                ...
                                <asp:ImageButton ID="btn_update" runat="server" ImageUrl="~/Menu_image/Submit.jpg"
                                    Style="cursor: pointer;" OnClientClick="return valtooline();" OnClick="btn_update_Click" /></div>
                        </div>
                    </td>
                </tr>
            </table>
    ...
    <div align="center">
        <asp:GridView ID="grid_abumaster" runat="server" BorderColor="AliceBlue" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="S.No" HeaderStyle-BackColor="#4c6c9f" HeaderStyle-ForeColor="#FFFFFF"
                    Visible="false">
                    <ItemTemplate>
                        <asp:Label ID="lbl_id" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "LID") %>'
                ...
                <asp:TemplateField HeaderText="Tool Value">
                    <ItemTemplate>
                        <asp:Label ID="lbl_tool" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "LValue") %>'
                ...
                <asp:TemplateField HeaderText="Tool Name">
                    <ItemTemplate>
                        <asp:Label ID="lbl_avail" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "LText") %>'
                            Style="font-size: 15px; text-align: center;"></asp:Label>
                    </ItemTemplate>
                    <HeaderStyle Width="200" BackColor="#4C6C9F" Font-Size="Small" ForeColor="White" />
                    <ItemStyle Width="200" BackColor="White" HorizontalAlign="Center" BorderColor="Black" />
                ...
                <asp:TemplateField HeaderText="Edit" ControlStyle-Width="50pt">
                    <ItemTemplate>
                        <a id="<%# Eval("LID") %>" onclick="javascript:edit_line(this.id);">
                ...
                <asp:TemplateField HeaderText="Delete" ControlStyle-Width="50pt">
                    <ItemTemplate>
                        <a id="<%# Eval("LID") %>" onclick="javascript:delete_line(this.id);">
     ...
     <div>
        <input type="hidden" id="hdn_lineid" name="hdn_lineid" runat="server" />
    </div>
</asp:Content>
