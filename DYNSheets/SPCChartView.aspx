<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SPCChartView.aspx.cs" Inherits="DYNSheets_SPCChartView" %>
...
<body>
    ...
    <div id="div_chart" runat="server">
        ...
        <tr>
        <td>
        <div align="center"><span style="font-family:Arial;font-size:24px;font-weight:bold;text-decoration: underline;"> X Bar Chart</span></div>
        </td>
        </tr>
            <tr>
                ...
                <td>
                    <asp:Chart ID="QC_Chart" runat="server" Height="700px" Width="1200px" BackColor="#eefaff" >
                        <Series>
                            ...
                            <asp:Series BorderWidth="2" Color="DarkGreen" Name="Series10" ChartType="Line" BorderDashStyle="Solid"
                                ChartArea="ChartArea1">
                            </asp:Series>
                        </Series>
                        <ChartAreas>
                                    ...
                                    <div>
                                        <table>
                                            <tr>
                                                <td style="color: Black; font-size: 20px; font-family: Verdana, Times New Roman;
                                                    font-weight: bold">
                                                    <span id="spcp" runat="server">Pp</span>
                                                </td>
                                                <td style="color: Black; font-size: 20px; font-family: Verdana, Times New Roman;
                                                    font-weight: bold">
                                            ...
                                            <tr>
                                                <td style="color: Black; font-size: 20px; font-family: Verdana, Times New Roman;
                                                    font-weight: bold">
                                                    <span id="spcpk" runat="server">Ppk</span>
                                                </td>
                                                <td style="color: Black; font-size: 20px; font-family: Verdana, Times New Roman;
                                                    font-weight: bold">
    ...
    <div id="div_Rchart" runat="server">
        <table>
        <tr><td style="width: 30px;"></td></tr>
        <tr>
        <td>
        <div align="center"><span style="font-family:Arial;font-size:24px;font-weight:bold;text-decoration: underline;">R Chart</span></div>
        </td>
        </tr>
            <tr>
                <td>
                    <asp:Chart ID="QC_RChart" runat="server" Height="700px" Width="1200px" BackColor="#eefaff">
                        <Series>
                            <asp:Series BorderWidth="2" Color="SkyBlue" Name="Series1" ChartType="Line" ChartArea="ChartArea1"
                                YValueType="Double" XValueType="Auto" MarkerStyle="Square" MarkerColor="Black">
                            </asp:Series>
                                    ...
                                    <%--<div style="float: left;">
                                        <table>
                                            <tr>
                                                <td style="color: Black; font-size: 20px; font-family: Verdana, Times New Roman;
                                                    font-weight: bold">
                                                    <span id="Span1" runat="server">USL</span>
                                                </td>
                                                <td style="color: Black; font-size: 20px; font-family: Verdana, Times New Roman;
                                                    font-weight: bold">
                                                ...
                                                <td style="color: Black; font-size: 20px; font-family: Verdana, Times New Roman;
                                                    font-weight: bold;">
                                                    <span id="sp_usl1" runat="server"></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="color: Black; font-size: 20px; font-family: Verdana, Times New Roman;
                                                    font-weight: bold">
                                                    <span id="Span4" runat="server">LSL</span>
                                                </td>
                                                <td style="color: Black; font-size: 20px; font-family: Verdana, Times New Roman;
                                                    font-weight: bold">
                                                ...
                                                <td style="color: Black; font-size: 20px; font-family: Verdana, Times New Roman;
                                                    font-weight: bold">
                                                    <span id="sp_lsl1" runat="server"></span>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>--%>
                                    ...
                                    <div>
                                        <table>
                                            <tr>
                                                <td style="color: Black; font-size: 20px; font-family: Verdana, Times New Roman;
                                                    font-weight: bold">
                                                    <span id="Span7" runat="server">UCL</span>
                                                </td>
                                                <td style="color: Black; font-size: 20px; font-family: Verdana, Times New Roman;
                                                    font-weight: bold">
                                                ...
                                                <td style="color: Black; font-size: 20px; font-family: Verdana, Times New Roman;
                                                    font-weight: bold;">
                                                    <span id="sp_CP1" runat="server"></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="color: Black; font-size: 20px; font-family: Verdana, Times New Roman;
                                                    font-weight: bold">
                                                    <span id="Span10" runat="server">LCL</span>
                                                </td>
                                                <td style="color: Black; font-size: 20px; font-family: Verdana, Times New Roman;
                                                    font-weight: bold">
                                                ...
                                                <td style="color: Black; font-size: 20px; font-family: Verdana, Times New Roman;
                                                    font-weight: bold">
                                                    <span id="sp_CPK1" runat="server"></span>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
