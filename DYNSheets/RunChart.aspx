<%@ Page Language="C#" MasterPageFile="~/MasterPage1.master" AutoEventWireup="true" CodeFile="RunChart.aspx.cs" Inherits="DYNSheets_RunChart" Title="Run Chart" %>
  ...
  <div style="margin-top: -30px;" id="div_header" runat="server">
        <table align="left">
            <tr>
                ...
                <td>
                    <asp:Label ID="Label33" runat="server" Text="RUN CHART" valign="left" Font-Bold="true"
    ...
    <div style="background-color: #eefaff;" id="div_chart1" align="center" runat="server">
        <table>
            ...
            <tr style="height: 5px;">
                <td colspan="3">
                            ...
                            <tr>
                                ...
                                <td style="width: 446px">
                                    <select id="ddl_cell" onchange="javascript:validatecell();" class="dropdownstyle"
                                        runat="server">
                                        <option value="0" selected="selected">-- Select Cell ---</option>
                                    </select>
                                </td>
                            ...
                            <tr>
                                <td colspan="3">
                                    <div align="center" style="padding-left: 80px;">
                                        <img src="../Menu_image/view.jpg" id="btn_runchart" style="cursor: pointer;" />
                                    </div>
                                </td>
                            </tr>
                        </table>
                ...
                <td valign="top">
                    <div id="Div1" style="padding-left: 50px;" runat="server">
                        <table>
                            <tr style="height: 5px;">
                                <td colspan="3">
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span id="spn_runUSL" runat="server"></span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <span id="spn_runUCL" runat="server"></span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <span id="spn_runPMean" runat="server"></span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <span id="spn_runMean" runat="server"></span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span id="spn_runLCL" runat="server"></span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <span id="spn_runLSL" runat="server"></span>
                                </td>
                            </tr>
                        </table>
    ...
    <span style="font-family:Arial Black; font-size:35px; font-weight:bold; color:Red;" id="spn_error"></span>
    </div>
</asp:Content>
