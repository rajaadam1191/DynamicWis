<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RunChartView.aspx.cs" Inherits="DYNSheets_RunChartView" %>
                                    ...
                                    <div>
                                        <table>
                                            <tr>
                                                <td style="color: Black; font-size: 20px; font-family: Verdana, Times New Roman;
                                                    font-weight: bold">
                                                    <span id="spcp" runat="server">UCL</span>
                                                </td>
                                                <td style="color: Black; font-size: 20px; font-family: Verdana, Times New Roman;
                                                    font-weight: bold">
                                            ...
                                            <tr>
                                                <td style="color: Black; font-size: 20px; font-family: Verdana, Times New Roman;
                                                    font-weight: bold">
                                                    <span id="spcpk" runat="server">LCL</span>
                                                </td>
                                                <td style="color: Black; font-size: 20px; font-family: Verdana, Times New Roman;
                                                    font-weight: bold">
