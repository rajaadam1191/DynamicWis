<%@ Page Language="C#" MasterPageFile="~/MasterPage1.master" AutoEventWireup="true"
    CodeFile="LineMaster.aspx.cs" Inherits="ABU_Master" Title="Untitled Page" %>
    ...
    <div>
        ...
        <div>
            <table align="center">
                <tr>
                    <td align="left">
                        <span class="lablestyle">Tool Line Value</span>
                    </td>
                    <td>
                        :
                    </td>
                ...
                <tr>
                    <td align="left">
                        <span class="lablestyle">Tool Line Name</span>
                    </td>
                    <td>
                        :
                    </td>
        ...
        <asp:GridView ID="grid_abumaster" runat="server" BorderColor="AliceBlue" AutoGenerateColumns="false">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Edit" ControlStyle-Width="50pt">
                    <ItemTemplate>
                        <a id="<%# Eval("LID") %>" onclick="javascript:edit_linembu(this.id);">
                ...
                <asp:TemplateField HeaderText="Delete" ControlStyle-Width="50pt">
                    <ItemTemplate>
                        <a id="<%# Eval("LID") %>" onclick="javascript:delete_linembu(this.id);">
