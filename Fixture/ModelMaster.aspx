<%@ Page Language="C#" MasterPageFile="~/MasterPage1.master" AutoEventWireup="true"
    CodeFile="ModelMaster.aspx.cs" Inherits="ABU_Master" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <div>
        ...
        <div>
            <table align="center">
                <tr>
                    <td align="left">
                        <span class="lablestyle">Model Name</span>
                    </td>
                    <td>
                        :
                    </td>
                    <td colspan="2">
                        <input type="text" id="txt_modelname" class="textboxstyle" runat="server" />
                    </td>
                </tr>
                <tr style="height: 5px;">
                    <td colspan="4">
                        ...
                        <div align="center">
                            ...
                            <div align="center" style="padding-left: 30px; display: none;" id="div_toolupdate"
                                ...
                                <asp:ImageButton ID="btn_update" runat="server" ImageUrl="~/Menu_image/Submit.jpg"
                                    Style="cursor: pointer;" OnClick="btn_update_Click1" /></div>
                        </div>
                    </td>
                </tr>
            </table>
                    ...
                    <div>
                        <asp:GridView ID="grid_abumaster" runat="server" BorderColor="AliceBlue" AutoGenerateColumns="false">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Model Value">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Edit" ControlStyle-Width="50pt">
                                    <ItemTemplate>
                                        <a id="<%# Eval("ID") %>" onclick="javascript:edit_mmaster(this.id);">
                                ...
                                <asp:TemplateField HeaderText="Delete" ControlStyle-Width="50pt">
                                    <ItemTemplate>
                                        <a id="<%# Eval("ID") %>" onclick="javascript:delete_mmaster(this.id);">
    ...
    <div>
        <input type="hidden" id="hdn_modelid" name="hdn_modelid" runat="server" />
    </div>
</asp:Content>
