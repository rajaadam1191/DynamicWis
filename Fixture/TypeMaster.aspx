<%@ Page Language="C#" MasterPageFile="~/MasterPage1.master" AutoEventWireup="true"
    CodeFile="TypeMaster.aspx.cs" Inherits="ABU_Master" Title="Untitled Page" %>
    ...
    <div>
        ...
        <div>
            <table align="center">
                <tr>
                    <td align="left">
                        <span class="lablestyle">Tool Type Value</span>
                    </td>
                    <td>
                        :
                    </td>
                    <td colspan="2">
                        <input type="text" id="txt_ttype" class="textboxstyle" runat="server" maxlength="2" />
                    </td>
                </tr>
                <tr style="height: 5px;">
                    <td colspan="4">
                ...
                <tr>
                    <td align="left">
                        <span class="lablestyle">Tool Type Name</span>
                    </td>
                    <td>
                        :
                    </td>
        ...
        <asp:GridView ID="grid_abumaster" runat="server" BorderColor="AliceBlue" AutoGenerateColumns="false">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Edit" ControlStyle-Width="50pt">
                    <ItemTemplate>
                        <a id="<%# Eval("TID") %>" onclick="javascript:edit_TTypembu(this.id);">
                ...
                <asp:TemplateField HeaderText="Delete" ControlStyle-Width="50pt">
                    <ItemTemplate>
                        <a id="<%# Eval("TID") %>" onclick="javascript:delete_TTypembu(this.id);">
